...
Nova.booting(function (Vue, router) {
    Vue.component('index-saudi_id_number', __webpack_require__(3));
    Vue.component('detail-saudi_id_number', __webpack_require__(6));
    Vue.component('form-saudi_id_number', __webpack_require__(9));
});
